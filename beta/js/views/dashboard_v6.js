...
const VERSION = '18.4.4-BETA';
const CACHE_KEY = `logistics_v18_4_4_beta_shared_`;
  ...
  */
      ...
      <div class="topbar-brand">
        <div style="display:flex; align-items:center; gap:10px;">
          <h2 style="font-weight:700; color:#fff; display:flex; align-items:center; gap:8px;">
            ...
            <span style="font-size:12px; color:rgba(255,255,255,0.4); font-weight:400; margin-left:5px;">v18.4.4</span>
          </h2>
        </div>
      </div>
  ...
  const displayReporteUCA = (results) => {
    ...
    container.innerHTML = `
      ...
      <div style="display:grid; grid-template-columns: 0.9fr 1.1fr; gap:1rem; align-items: start; margin-bottom: 2rem;">
        <!-- TABLA GENERAL -->
              ...
              <tbody>
                ${discrepancias.length === 0 ? '<tr><td colspan="5" style="text-align:center; color:var(--text-muted); padding:2rem; font-size:0.8rem;">No se encontraron discrepancias</td></tr>' : 
                  ...
                  <tr>
                    ...
                    <td style="font-size:0.6rem; color:var(--text-muted); padding:6px 8px; word-break: break-all;">${r.detalle}</td>
                  </tr>
                `).join('')}
              </tbody>
            </table>
