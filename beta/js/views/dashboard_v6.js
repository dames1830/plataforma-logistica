import { parseFile, parseBufferFiles, getAreaData, clearAreaData, generateKPIs, calculateBufferPallets, fetchBufferConfig, logSystemAction, pingServer, saveBufferReport, loadBufferReport, fetchBufferHistory, dataStore, setDateFilter, currentDateFilter, getUploadMeta, initPersistentData, updateTablaTallas } from '../services/csvHub_v6.js?v=16.0.4';
import * as adminService from '../services/adminService.js?v=16.0.4';


const VERSION = '16.0.4-BETA';
const CACHE_KEY = `logistics_v16_0_4_beta_clean_`;
