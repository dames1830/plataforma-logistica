import { parseFile, parseBufferFiles, getAreaData, clearAreaData, generateKPIs, calculateBufferPallets, fetchBufferConfig, logSystemAction, pingServer, saveBufferReport, loadBufferReport, fetchBufferHistory, dataStore, setDateFilter, currentDateFilter, getUploadMeta, initPersistentData, updateTablaTallas } from '../services/csvHub_v6.js?v=15.9.6';
import * as adminService from '../services/adminService.js?v=15.9.6';


const VERSION = '15.9.6-BETA';
const CACHE_KEY = `logistics_v15_9_6_beta_clean_`;
                                        ...
                                        <tr style="border-bottom:1px solid rgba(255,255,255,0.02); transition: all 0.2s;">
                                            ...
                                            <td style="padding:0.8rem 1rem; text-align:center;">
                                                <div style="width:100%; height:4px; background:rgba(255,255,255,0.05); border-radius:10px; margin-bottom:4px;">
                                                    <div style="width:${Math.min(r.pct, 100)}%; height:100%; background:${r.ok?'#22c55e':'#ef4444'}; border-radius:10px;"></div>
                                                </div>
                        ...
                        <tbody>
                            ...
                            ${!isDetail ? tasks.filter(t => !selectedTaskDate || t.fecha === selectedTaskDate).map(t => {
                                ...
                                <tr style="border-bottom:1px solid rgba(255,255,255,0.03); cursor:pointer;" onclick="window.assignTask('${t.id}')">
                                    ...
                                    <td style="padding:0.8rem 1rem; text-align:center; color:#fff; font-weight:900;">${productividad}</td>
