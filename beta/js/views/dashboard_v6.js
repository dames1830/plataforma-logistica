...
const VERSION = '18.4.3-BETA';
const CACHE_KEY = `logistics_v18_4_3_beta_shared_`;
  ...
  */
      ...
      <div class="topbar-brand">
        <div style="display:flex; align-items:center; gap:10px;">
          <h2 style="font-weight:700; color:#fff; display:flex; align-items:center; gap:8px;">
            ...
            <span style="font-size:12px; color:rgba(255,255,255,0.4); font-weight:400; margin-left:5px;">v18.4.3</span>
          </h2>
        </div>
      </div>
  ...
  const displayReporteUCA = (results) => {
    ...
    container.innerHTML = `
      ...
      <div style="display:grid; grid-template-columns: 0.7fr 1.3fr; gap:1rem; align-items: start; margin-bottom: 2rem;">
        <!-- TABLA GENERAL -->
