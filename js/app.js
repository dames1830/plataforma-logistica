 ...
 */
import { getSession, logout } from './services_v245/auth.js?v=25.1.99';
import * as adminService from './services_v245/adminService.js?v=25.1.99';

class App {
  constructor(rootId) {
    this.root = document.getElementById(rootId);
    this.APP_VERSION = 'v25.1.99';
