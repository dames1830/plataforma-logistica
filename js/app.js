 ...
 */
import { getSession, logout } from './services_v245/auth.js?v=24.6.0';
import * as adminService from './services_v245/adminService.js?v=24.6.0';

class App {
  constructor(rootId) {
    this.root = document.getElementById(rootId);
    this.APP_VERSION = 'v24.6.0';
