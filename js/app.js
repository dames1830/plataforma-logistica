 ...
 */
import { getSession, logout } from './services/auth.js?v=24.4.4';
import * as adminService from './services/adminService.js?v=24.4.4';
...
class App {
  ...
  async render(user) {
    ...
    try {
        if (user) {
            const { renderDashboard } = await import(`./views/dashboard_v24.js?v=24.4.4`);
            this.root.innerHTML = '';
