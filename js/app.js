/**
 * App Entry Point v24.4.0 - SECURE SYNC
 */
import { getSession, logout } from './services/auth.js?v=24.4.0';
...
class App {
  ...
  async render(user) {
    ...
    try {
        if (user) {
            const { renderDashboard } = await import(`./views/dashboard_v24.js?v=24.4.0`);
            this.root.innerHTML = '';
