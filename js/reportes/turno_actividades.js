...
export const montarTurno = function (RAIZ, OPC) {
  ...
  RAIZ.addEventListener('click', function (e) {
    ...
    if (e.target.id === 'ta_b_reset') { S = JSON.parse(JSON.stringify(BASE)); arrancar(); }
  });
