...
export const montarTurno = function (RAIZ, OPC) {
  ...
  /* LA FECHA Y LA HORA, al lado de cada título. Sale del reloj, o de la foto
     de stock si se cargó una: así los dos cuadros dicen SIEMPRE el mismo
     momento, y no hay forma de mirar uno creyendo que es de otra hora. */
  function fechaHora() {
    var d = new Date();
