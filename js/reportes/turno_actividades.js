...
export const montarTurno = function (RAIZ, OPC) {
  ...
  function pintarCandado() {
    ...
    b.disabled = cerrada;
    b.innerHTML = (fija ? '\uD83D\uDD12' : '\uD83D\uDD13')
      + '<span>' + (fija ? 'Meta congelada' : 'Meta abierta') + '</span>';
    b.title = cerrada
