...
const CACHE_KEY = `logistics_v17.5.0__shared_`;
      ...
      <div class="topbar-brand">
        <div style="display:flex; align-items:center; gap:10px;">
          <h2 style="font-weight:700; color:#fff; display:flex; align-items:center; gap:8px;">
            ...
            <span style="background:#fbbf24; color:#000; padding:2px 8px; border-radius:4px; font-size:11px; font-weight:900; vertical-align:middle; margin-left:4px; box-shadow: 0 0 10px rgba(251,191,36,0.3);"></span>
            <span style="font-size:12px; color:rgba(255,255,255,0.4); font-weight:400; margin-left:5px;">v17.5.0</span>
          </h2>
        </div>
      </div>
