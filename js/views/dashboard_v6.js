/**
 * Dashboard View Module v17.4.8 - PRODUCTION
 * Centralized Logic for Logistics, Performance, and Almacenaje
 * CLEANED FROM BETA BRANDING
 */

import { adminService } from '../services/adminService.js?v=17.4.8';
import { 
  dataStore, 
  getAreaData, 
  ...
  saveBufferReport, 
  updateTablaTallas 
} from '../services/csvHub_v6.js?v=17.4.8';
    ...
    tabContent.innerHTML = `
        <div class="kpi-grid">
            ...
            <div class="kpi-card">
                ...
                <span class="kpi-subtitle">Sistema v17.4.8</span>
            </div>
        </div>
    ...
    tabContent.innerHTML = `
        <div class="glass-panel animate-fade-in" style="max-width:600px; padding:2rem;">
            ...
            <div class="config-list">
                <div class="config-item"><span>Versión del Core</span><span class="badge primary">v17.4.8</span></div>
