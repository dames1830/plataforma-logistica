import { parseFile, parseBufferFiles, getAreaData, clearAreaData, generateKPIs, calculateBufferPallets, fetchBufferConfig, logSystemAction, pingServer, saveBufferReport, loadBufferReport, fetchBufferHistory, dataStore, setDateFilter, currentDateFilter, getUploadMeta, initPersistentData, updateTablaTallas, getCol } from '../services_v245/csvHub_v6.js?v=25.1.94';
// PULSE_ENGINE_V18_2_0_CLEAN_BUILD
import * as adminService from '../services_v245/adminService.js?v=25.1.94';
import { login as authLogin, getSession } from '../services_v245/auth.js?v=25.1.94';
import * as syncEngine from '../services_v245/sync_engine_v24_9.js?v=25.1.94';
import * as cyclicService from '../services_v245/cyclicCountService.js?v=25.1.94';
  ...
  */
  ...
  const renderAdminTab = () => {
    ...
    window.executeResurrection = async () => {
        ...
        try {
            const { saveUsers, savePermissions, save, savePerformanceLog } = await import('../services_v245/adminService.js?v=25.1.94');
  ...
  // --- INICIO MÓDULO TRACKING DESPACHO (v25.1.94) ---
