import { parseFile, parseBufferFiles, getAreaData, clearAreaData, generateKPIs, calculateBufferPallets, fetchBufferConfig, saveBufferConfig, logSystemAction, pingServer, saveBufferReport, loadBufferReport, fetchBufferHistory, dataStore, setDateFilter, currentDateFilter, getUploadMeta, initPersistentData, updateTablaTallas, getCol, getAreaLength } from '../services_v245/csvHub_v6.js?v=26.5.166';
// PULSE_ENGINE_V18_2_0_CLEAN_BUILD
import * as adminService from '../services_v245/adminService.js?v=26.5.166';
import { login as authLogin, getSession } from '../services_v245/auth.js?v=26.5.166';
import * as syncEngine from '../services_v245/sync_engine_v24_9.js?v=26.5.166';
import * as cyclicService from '../services_v245/cyclicCountService.js?v=26.5.166';
                    ...
                    <div style="flex-grow:1; overflow-y:auto; padding-bottom: 4.5rem;" id="nr_content_wrapper">
                        ${renderActiveTabContent(activeTab, capitalizedToday, pendingCount, totalCount)}
                            <div style="text-align: center; margin-top: 2rem; margin-bottom: 1.5rem; font-size: 0.65rem; color: rgba(255,255,255,0.25); font-weight: 700; letter-spacing: 0.05em;">
                                SYSTEM BUILD: v26.5.166 | MOBILE PORTAL
                            </div>
                    </div>
