import { parseFile, parseBufferFiles, getAreaData, clearAreaData, generateKPIs, calculateBufferPallets, fetchBufferConfig, logSystemAction, pingServer, saveBufferReport, loadBufferReport, fetchBufferHistory, dataStore, setDateFilter, currentDateFilter, getUploadMeta, initPersistentData, updateTablaTallas, getCol } from '../services_v245/csvHub_v6.js?v=24.5.3';
// PULSE_ENGINE_V18_2_0_CLEAN_BUILD
import * as adminService from '../services_v245/adminService.js?v=24.5.3';


const VERSION = '24.5.3';
      ...
      <div class="topbar-brand">
        <div style="display:flex; align-items:center; gap:10px;">
          <h2 style="font-weight:700; color:#fff; display:flex; align-items:center; gap:8px;">
            ...
            <span style="font-size:12px; color:#fbbf24; font-weight:900; margin-left:5px;">v24.5.3</span>
          </h2>
        </div>
      </div>
  ...
  const renderAdminTab = () => {
    ...
    contentArea.innerHTML = `
        <div id="resurrection_banner" style="background:linear-gradient(90deg, #f59e0b, #d97706); padding:0.8rem; border-radius:12px; margin-bottom:1.5rem; display:flex; justify-content:space-between; align-items:center; box-shadow:0 10px 20px rgba(245, 158, 11, 0.2); border:1px solid rgba(255,255,255,0.2);">
            <div style="display:flex; align-items:center; gap:12px;">
                ...
                <div>
                    <div style="font-weight:900; color:white; font-size:0.85rem; letter-spacing:0.5px;"> PROTOCOLO DE RESURRECCIÓN v24.5.3</div>
    ...
    if (masterBtn) {
        masterBtn.addEventListener('click', async () => {
            console.log("🚀 [DEBUG] Botón de Resurrección presionado.");
            ...
            try {
                ...
                const { saveUsers, savePermissions, save, savePerformanceLog } = await import('../services_v245/adminService.js?v=24.5.3');
            ...
            // 5. Performance Log (Nuevo!)
            console.log("📡 [PULSE] Restaurando Performance Log...");
            ...
            alert("🏗️ RESURRECCIÓN COMPLETADA v24.5.3 🏗️\n\nSe han restaurado:\n- Trabajadores\n- Usuarios y Permisos\n- Asistencia\n- Historial de Performance");
            location.reload();
        } catch (e) {
            console.error(e);
