...
import * as adminService from '../services_v245/adminService.js?v=24.6.1';
  ...
  */
  ...
  const renderAdminTab = () => {
    ...
    contentArea.innerHTML = `
        <div id="resurrection_banner" style="background:linear-gradient(90deg, #f59e0b, #d97706); padding:0.8rem; border-radius:12px; margin-bottom:1.5rem; display:flex; justify-content:space-between; align-items:center; box-shadow:0 10px 20px rgba(245, 158, 11, 0.2); border:1px solid rgba(255,255,255,0.2);">
            <div style="display:flex; align-items:center; gap:12px;">
                ...
                <div>
                    <div style="font-weight:900; color:white; font-size:0.85rem; letter-spacing:0.5px;"> PROTOCOLO DE RESURRECCIÓN v24.6.1</div>
    ...
    window.executeResurrection = async () => {
        ...
        try {
            const { saveUsers, savePermissions, save, savePerformanceLog } = await import('../services_v245/adminService.js?v=24.6.1');
