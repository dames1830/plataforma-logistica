...
} from '../services_v245/csvHub_v6.js?v=29.0805';

import * as adminService from '../services_v245/adminService.js?v=29.0805';
import { marcaNormalizada, marcaCorta, rotuloRango, selectorRango, diaOperativoDeTarea as diaOperativoCompartido } from '../services_v245/reportesComunes.js?v=29.0805';
import { datosMarcas, filasMarcas, cabeceraMarcas, armarTurnoDe, TEMA_CLARO } from '../reportes/marcas.js?v=29.0805';
import { renderLayoutActivo } from './public_layout_activo.js?v=29.0805';
import * as jornadaService from '../services_v245/jornadaService.js?v=29.0805';
...
import { CATALOGO as CAT_PUB, buscarSub, permisosDe as permisosPub }
    from '../services_v245/catalogoReportesPublicos.js?v=29.0805';
...
import { traerAreaPublicada } from '../services_v245/csvHub_v6.js?v=29.0805';
import { traerSellos, chipSello } from '../services_v245/selloService.js?v=29.0805';
...
import * as distribucionReporte from '../reportes/distribucion.js?v=29.0805';
...
function renderShell(app) {
  ...
  app.innerHTML = `
    ...
    <div style="border-top:1px solid var(--border); background:var(--surface); padding:0.75rem 1.5rem; text-align:center; color:var(--text-muted); font-size:0.68rem; font-weight:600; letter-spacing:0.5px;">
      ...
      <span style="color:var(--text-muted); font-weight:500;">v29.0805</span>
    </div>`;
