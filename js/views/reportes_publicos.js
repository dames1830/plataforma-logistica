...
} from '../services_v245/csvHub_v6.js?v=26.5.510';

import * as adminService from '../services_v245/adminService.js?v=26.5.510';
import { renderLayoutActivo } from './public_layout_activo.js?v=26.5.510';
    ...
    <div class="topbar">
      <div class="topbar-brand">
        <h2>LOGÍSTICA <span style="color:#818cf8">DEAM1830</span>
          <span style="font-size:11px; color:#fbbf24; font-weight:900; margin-left:4px">v26.5.510</span>
        </h2>
