...
} from '../services_v245/csvHub_v6.js?v=29.0493';

import * as adminService from '../services_v245/adminService.js?v=29.0493';
import { marcaNormalizada, marcaCorta, rotuloRango, selectorRango, diaOperativoDeTarea as diaOperativoCompartido } from '../services_v245/reportesComunes.js?v=29.0493';
import { datosMarcas, filasMarcas, cabeceraMarcas, armarTurnoDe, TEMA_CLARO } from '../reportes/marcas.js?v=29.0493';
import { renderLayoutActivo } from './public_layout_activo.js?v=29.0493';
import * as jornadaService from '../services_v245/jornadaService.js?v=29.0493';
...
function renderShell(app) {
  ...
  app.innerHTML = `
    ...
    <div style="border-top:1px solid var(--border); background:var(--surface); padding:0.75rem 1.5rem; text-align:center; color:var(--text-muted); font-size:0.68rem; font-weight:600; letter-spacing:0.5px;">
      ...
      <span style="color:var(--text-muted); font-weight:500;">v29.0493</span>
    </div>`;
